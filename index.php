		...
		<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
		  ...
		  <div class="modal-content">
		      <div class="modal-header">
		          <h1 class="text-center">Sistema de Tele Entregas</h1>
		      </div>
		          ...
		          <form class="form col-md-12 center-block" method="POST" id="form" name="form" action="indexAcao.php">
		            ...
		            <div class="form-group">
		            	<label for="DsSenha">Senha</label>
		              	<input type="password" id="DsSenha" name="DsSenha" class="form-control input-lg" maxlength="8" placeholder="digite sua senha" required>
		            </div>
		            <div class="form-group">
